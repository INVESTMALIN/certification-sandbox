            ...
            <header className="font-airbnb bg-white border-b border-gray-200 sticky top-0 z-40">
                <div className="w-full px-6 py-6 flex items-center">
                    ...
                    <div className="ml-auto flex items-center gap-4">
                        <button className="text-sm text-gray-700 hover:text-gray-900 hidden md:block">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 text-gray-700 hover:bg-gray-100 px-3 py-2 rounded transition-colors"
                        >
